export const uniqueFieldMessages = {
  ...
  pan_number:
    "The PAN number is already in use. Please use a different PAN number.",
  gst_number:
    "The GST number is already in use. Please use a different GST number.",
  adhaar_number:
    "The Aadhaar number is already in use. Please use a different Aadhaar number.",
  phone_number:
